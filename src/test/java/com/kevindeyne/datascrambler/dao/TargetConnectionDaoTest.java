...
public class TargetConnectionDaoTest {
    ...
    @Test
    public void testWith50Distribution() {
        ...
        percentages.put(50D, new ValueDistribution.MutableInt(2));
        ...
        Mockito.verify(generationService, Mockito.times(2)).generate(anyString(), anyInt(), anyString());
    }
